...
export default function TierListPage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <FaqJsonLd items={siteConfig.gameName ? [{ q: "Is there a Monobombo character tier list?", a: "No public character, item, or mode tier list was confirmed on Wednesday, July 29, 2026. This page keeps the Monobombo tier list focused on checked role ranking confidence until a broader Roblox meta appears." }] : []} />
