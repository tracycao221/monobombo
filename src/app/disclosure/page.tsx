      ...
      <section className="mt-4 grid gap-4">
        <article className="content-card">
          ...
          <p className="mt-2 leading-7 text-white/68">
            ...
            when monetization is enabled. Ads do not change the source standard for codes, guides,
        ...
        <article className="content-card">
          ...
          <p className="mt-2 leading-7 text-white/68">
            Use the contact page to report outdated codes, incorrect source status, unclear guide notes,
            or rights concerns.
          </p>
        </article>
      </section>
