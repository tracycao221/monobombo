...
export const metadata: Metadata = {
  ...
  description: `Source and verification notes for ${siteConfig.gameName} codes, guides, wiki claims, and community-link updates.`,
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        ...
        title={`${siteConfig.gameName} Sources`}
        description="Use this page to see where code, update, Trello, Discord, wiki, and guide claims are checked. Official Roblox pages should win when sources disagree."
      />
