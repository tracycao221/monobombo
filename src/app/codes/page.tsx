  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        ...
        title={`${siteConfig.gameName} Codes`}
        description="No public Monobombo codes were confirmed during the Wednesday, July 29, 2026 check. This page stays live so players can see the checked status without mixing Monobombo with Monkey Bomb Tag or other monkey bomb games."
      />
      <AdsterraArticleTop />
        ...
        {activeCodes.length === 0 ? (
          <article className="content-card mt-6">
            ...
            <p className="mt-3 text-white/70">
              ...
              list, reward, or redemption UI during the Wednesday, July 29, 2026 check. Monkey Bomb Tag codes are not
              Monobombo codes.
            </p>
            <p className="mt-2 text-sm text-white/45">Checked: July 29, 2026</p>
          </article>
        ) : (
      ...
      <section className="mt-10 grid gap-4 lg:grid-cols-2">
        <article className="content-card">
          <SectionHeader
            ...
            copy="No Monobombo redemption panel was verified on Wednesday, July 29, 2026. These checks are used before any future code is published."
          />
