    ...
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <section className="mt-10 grid gap-4 lg:grid-cols-2">
        <article className="content-card">
          ...
          <p className="mt-3 text-sm leading-6 text-white/68">No public Monobombo code or reward text was confirmed on Friday, July 24, 2026, so this page treats code claims as pending until a checked source appears.</p>
        </article>
        <article className="content-card">
