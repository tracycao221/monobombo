  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        eyebrow="Wiki hub"
        title={`${siteConfig.gameName} Wiki`}
        description="Use this hub for the three monkey roles, bomb-defusal basics, source status, and mode notes that have been verified."
      />
      <AdsterraArticleTop />
      ...
      <section className="mt-10">
        <SectionHeader
          ...
          copy="Start with the topics that affect your next round: role limits, team communication, source status, and verified mode notes."
        />
