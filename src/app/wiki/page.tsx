      ...
      <section className="mt-10">
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-2">
          ...
          <article className="content-card">
            ...
            <p className="mt-3 text-sm leading-6 text-white/68">As of Friday, August 7, 2026, Monobombo still has no public code list, no checked Trello board, no checked Discord invite, and no checked public wiki link.</p>
          </article>
        </div>
      </section>
